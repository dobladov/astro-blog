...
Then I saw this wonderful video from [Barney Codes](https://www.youtube.com/@BarneyCodes) and I loved how the flow field looked; He did a wonderful explanation and re-creating it was a breeze, a channel totally worth subscribing.
...
<img src={orbMeme.src} width={orbMeme.width} height={orbMeme.height} style={{width: "27rem",
    display: "flex",
    margin: "0 auto",
    maxWidth: "100%",
    left: 0,
