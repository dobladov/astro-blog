...
The problem is very simple, the ribbon connector for he display loses connection overtime, due to a very thin solder of the ribbons that's in tension.
...
- Intro about the piano
- How I got it
- Descriptiion of the problem
- First solution and why it failed
- Second solution
- Results
